...
!function(a, b) {
    ...
    return a.prototype.routes = {}, a.prototype.history = [], a.prototype.process = function() {
        var b = this, c = window.location.hash.replace("#", ""), d = b.match(), e = d.route, f = d.args, g = !0, h = !1, i = null, j = [];
        if (0 !== b.history.length && (h = b.routes[b.history[b.history.length - 1].matcher]), 
        e) {
            if (j = b.routes[e], h && h.unload) {
                h.unload.apply(this);
                for (var k in a.unloadFunctions) a.unloadFunctions[k].apply(i);
            }
            if (j.before && (g = j.before.apply(this, f), void 0 === g && (g = !0)), g || b.go(b.history[b.history.length - 1].fragment), 
            j.load && g) {
                var l = this.createSandbox(e);
                i = l, j.load.apply(l, f), b.history.push({
                    matcher: e,
                    fragment: c
                });
            }
