...
!function(a, b) {
    ...
    return a.prototype.routes = {}, a.prototype.process = function() {
        var a, b = this, c = window.location.hash.replace("#", ""), d = [];
        if ("/" === c || "" === c && b.routes.hasOwnProperty("/")) b.routes["/"].apply(this); else for (var e in b.routes) if (a = c.match(new RegExp(e.replace(/:[^\s/]+/g, "([\\w-]+)"))), 
        null !== a && "/" !== e) {
            if (d = [], a.length > 1) for (var f = 1, g = a.length; g > f; f++) d.push(a[f]);
            b.routes[e].apply(this, d);
        }
